...
export const portalAppConfigFields: SelectOptions<AOSPortalAppConfig> = {
  ...
  isAllowUserComment: true,
  isDisplayRelatedElements: true,
  taskDisplayTypeSelect: true,
  isDisplayTotalOpenTasks: true,
  isDisplayTotalOpenTickets: true,
  isDisplayTotalTimespent: true,
  isDisplayTotalInvoiced: true,
  isDisplayParentTask: true,
  isDisplayChildTasks: true,
  isDisplayRelatedTasks: true,
  isDisplayTimespentList: true,
  isDisplayTotalTimespentPerTask: true,
  taskFieldSet: {select: {name: true}},
  invoiceFieldSet: {select: {name: true}},
  timespentFieldSet: {select: {name: true}},
  isDisplayTaskCompletionReport: true,
  isDisplayTaskCompletionByMonthReport: true,
  isDisplayTicketCompletionReport: true,
  isDisplayTicketCompletionByMonthReport: true,
  isDisplayTaskProgressReport: true,
  isDisplayTaskProgressByMonthReport: true,
  isDisplayTicketProgressReport: true,
  isDisplayTicketProgressByMonthReport: true,
  isDiplayInvoiceByMonthReport: true,
  isDisplayTimespentByEmployeeReport: true,
  isDisplayTimespentByMonthReport: true,
  monthValueTypeSelect: true,
  resetValueDate: true,
  projectHeroTitle: true,
  projectHeroDescription: true,
  projectHeroOverlayColorSelect: true,
  projectHeroBgImage: {id: true, fileName: true},
