...
export const portalAppConfigFields: SelectOptions<AOSPortalAppConfig> = {
  ...
  isAllowTicketUpdate: true,
  isDisplayTaskList: true,
  isDisplayPerTaskOrProject: true,
  isDisplayTimeSpentComment: true,
  isDisplayRelatedElements: true,
  isDisplayTotalCompletedTasksReport: true,
  isDisplayOpenTasksReport: true,
  isDisplayTotalInvoicedReport: true,
  isDisplayPercentageCompletionReport: true,
  isDisplayProgressReport: true,
  isDisplayCompletedTasksReport: true,
  isDisplayCompletedTicketsReport: true,
  isDisplayTotalTimespentReport: true,
  isDisplayTotalInvoicesReport: true,
  isDisplayTotalConsoliatedSales: true,
  isDisplayEmployeeTimespent: true,
  isResetValuesOnYearStart: true,
